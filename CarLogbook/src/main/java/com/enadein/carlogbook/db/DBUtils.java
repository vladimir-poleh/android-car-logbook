...
//		Cursor cursor = cr.query(ProviderDescriptor.Log.CONTENT_URI,
//				new String[] {ProviderDescriptor.Log.Cols.ODOMETER},
//				"date < ? and " +  ProviderDescriptor.Log.Cols.CAR_ID + " = ?", new String[] { String.valueOf(dateT), String.valueOf(carId)}, ProviderDescriptor.Log.Cols.ODOMETER + " DESC");
//
//		if (cursor != null && cursor.moveToFirst()) {
//			result = cursor.getLong(0);
//			cursor.close();
...
//		Cursor cursor = cr.query(ProviderDescriptor.Log.CONTENT_URI,
//				new String[] {ProviderDescriptor.Log.Cols.ODOMETER},
//				"date < ? and " +  ProviderDescriptor.Log.Cols.CAR_ID + " = ?", new String[] {String.valueOf(dateT), String.valueOf(carId)}, null);
//
//		if (cursor != null && cursor.moveToFirst()) {
//			result = cursor.getLong(0);
//			cursor.close();
